# DC3 Boot Archive (Historical Notes, Deferred Backlog, Completed Milestones)

Purpose:
- Preserve historical debugging context and completed work without cluttering the active execution docs.
- Keep `CONTINUATION_PLAN.md`, `STATUS.md`, `TODO.md`, and `DEBUGGING_TIPS.md` focused on the current blocker and next actions.

Use this file for:
- old blocker snapshots,
- completed iteration logs,
- deferred backlog from earlier phases,
- historical concurrency planning and completion timelines.

Current source-of-truth working set:
- `docs/dc3-boot/CONTINUATION_PLAN.md`
- `docs/dc3-boot/STATUS.md`
- `docs/dc3-boot/TODO.md`
- `docs/dc3-boot/DEBUGGING_TIPS.md`

---

## Moved from `GOAL.md` (2026-02-25 cleanup)

### Historical blocker snapshot (2026-02-23, post NUI/XBC cutover)
...
## Moved from `TODO.md` (2026-02-25 cleanup)

The following sections were moved out of `TODO.md` to keep the active TODO focused on
the current CRT / `gStringTable` blocker.
...
## Iteration 3: First Frame — Get VdSwap Called (HISTORICAL / DEFERRED UNTIL POST-CRT)
...
### Historical Focus (Deferred): Trace VdSwap / Present Pipeline
